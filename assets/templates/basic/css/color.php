...
.pagination .page-item span,.username,.dashboard__sidebar__toggler,.job__price,.text--primary,.tag,.icon ,.breadcums li a:hover,.preloader .search-icon,.dashboard__sidebar__menu li::before, .menu .btn,.finished__job__item .job__header-title a:hover{
    color: <?php echo $color ?> !important;
}
.scrollToTop,.counter__item::before, .counter__item::after,.overview__content__wrapper.right-bg .btn,.read-more:hover::before,.bg--base,.cookie__wrapper {
    background-color: <?php echo $color ?> !important;
}
