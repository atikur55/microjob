...
class ManageUsersController extends Controller {
    ...
    public function detail($id) {
        ...
        $jobId    = JobProve::where('status', 1)->where('user_id', $id)->select('job_id')->get();
        $userEarn = JobPost::whereIn('id', $jobId)->sum('rate');
        return view('admin.users.detail', compact('pageTitle', 'user', 'totalDeposit', 'totalWithdraw', 'totalTransaction', 'countries', 'userEarn'));
    }
