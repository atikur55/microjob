    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--19 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $job['total_post']  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Job Post')</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--3 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $job['ongoing_post']  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Ongoing Jobs')</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--12 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $job['completed_post']  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Completed Jobs')</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--6 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $job['cancel_post']  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Cancel Jobs')</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row mt-50 mb-none-30">
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--15 b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $general->cur_sym }}{{ showAmount($job['total_balance']) }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Total Job Post')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--purple b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $general->cur_sym }}{{ showAmount($job['ongoing_balance'])  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Ongoing Jobs')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--green b-radius--10 box-shadow" >
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $general->cur_sym }}{{ showAmount($job['completed_balance'] ) }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Completed Jobs')</span>
                    </div>
        ...
        <div class="col-xl-3 col-lg-6 col-sm-6 mb-30">
            <div class="dashboard-w1 bg--14 b-radius--10 box-shadow">
                ...
                <div class="details">
                    <div class="numbers">
                        <span class="amount">{{ $general->cur_sym }}{{ showAmount($job['cancel_balance'])  }}</span>
                    </div>
                    <div class="desciption">
                        <span>@lang('Cancel Jobs')</span>
                    </div>
