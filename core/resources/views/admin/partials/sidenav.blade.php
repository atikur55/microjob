            ...
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.subcategory*')}}">
                    <a href="{{route('admin.subcategory.index')}}" class="nav-link ">
                        ...
                        <span class="menu-title">@lang('SubCategory')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{menuActive('admin.files*')}}">
                    <a href="{{route('admin.files.index')}}" class="nav-link ">
                        <i class="menu-icon las la-file"></i>
                        <span class="menu-title">@lang('Files')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.jobs*',3)}}">
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.jobs*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.jobs.index')}} ">
                                <a href="{{route('admin.jobs.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Jobs')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.jobs.pending')}} ">
                                <a href="{{route('admin.jobs.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Jobs')</span>
                                    @if($pending_job_count)
                                        <span class="menu-badge pill bg--primary ml-auto">{{$pending_job_count}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.jobs.approve')}} ">
                                <a href="{{route('admin.jobs.approve')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approve Jobs')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.jobs.complete')}} ">
                                <a href="{{route('admin.jobs.complete')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Completed Jobs')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.jobs.reject')}} ">
                                <a href="{{route('admin.jobs.reject')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>

                                    <span class="menu-title">@lang('Rejected Jobs')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
